...
first of all count the different hashtags that are used in the tweets and determine
which are the most popular ones. And second determine the sentiment score of a
tweet.\\
