...
filegroups have a single synchronization site. \cite{concepts} This site keeps
...
developed only a little. Choices always have to be made to emphasize one aspect
over the other. We do see that in the most recent system, Ceph, a significantly
better trade-off is made compared to the same type of trade-off made in LOCUS
over 20 years prior.
