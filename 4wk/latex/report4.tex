...
The data processed in this case are tweets and the goal of this program is to
first count the different hashtags that are used in the tweets and determine
which are the most popular ones. And second, try to determine the language in
which the tweets are written. The language is determined using the Standford
National Language Processing API.
